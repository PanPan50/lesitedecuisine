<?php
	...
	if(!isset($_GET['id']) OR $_GET['id'] == ''){
		header("location: errors.php?k=id");
	}
	$id = intval($_GET['id']);
    
    $viewShouts = get_shouts(null, null, null, $id);
...
<div id="main"><!-- MAIN -->
    <div class="content"><!-- CONTENT -->
        ...
        <?php
       	if($nbreMessages == 0){
       		echo "<div class='error'>Désolé il n'y a pas de correspondance avec votre recherche !</div>";
       	}else{
       		?>
       		<H1 id="titretribune">VOIR UN MESSAGE UNIQUE</H1>		
       		<div id="poststribune">
       		<?php
